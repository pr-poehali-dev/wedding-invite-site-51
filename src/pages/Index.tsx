    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative flex min-h-screen items-center justify-center text-center">
        ...
        <div className="relative z-10 px-6">
          ...
          <h1 className="mt-4 animate-fade-up font-display text-6xl font-500 leading-none text-white md:text-8xl lg:text-9xl">
            Артём <span className="font-script text-primary-foreground/80">&</span> Мария
          </h1>
          ...
          <p className="mt-4 animate-fade-up font-body text-white/80" style={{ animationDelay: '0.3s' }}>
            Загородный клуб «Сосновый берег», Подмосковье
          </p>
          <Button
            size="lg"
